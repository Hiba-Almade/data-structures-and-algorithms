...
const typeNum = (arr) => {
  // Solution code here...
  const numbers = arr.filter(element => !isNaN(element));
  return numbers;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  const strings = arr.filter(element => element.includes("and"));
  return strings;
};
...
const oddValues = (arr) => {
  // Solution code here...
  const numbers = arr.filter(element => element % 2 !== 0);
  return numbers;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  const strings = arr.filter(element => !forbiddenValues.includes(element));
  return strings;
};
